...
class Code(Parser):
    def __init__(self, address):
        super(Code, self).__init__(address)
...
class SymbolTable(Code):
    def __init__(self, address):
        super(SymbolTable, self).__init__(address)
...
class Assembler(SymbolTable):
    def __init__(self, address):
        super(Assembler, self).__init__(address)
        self.Constructor()
        self.holder = ''
