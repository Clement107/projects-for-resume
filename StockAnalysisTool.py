...
class StockAnalysisTool(StockTable):
    ...
    def set_price_volume_action_table(self, price_action_move_filter=None, volume_change_filter=None):
        """
        Takes in price_action_move_filter (integer) and volume_change (Boolean).
...
def main():
    ...
    stock = StockAnalysisTool('gm', date_from='01/01/2020', date_to=None, price_action_move_filter=-0.10, volume_change_filter=None)
